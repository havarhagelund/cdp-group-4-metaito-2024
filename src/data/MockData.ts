...
const mockPages: FormPage[] = [
    ...
    },
    {
        ...
        aiGenerated: true,
        generateQuestions: true,
        requirements: "- Ensure the question provides meaningful insights about the user's challenges.\\n- Use the user's previous answers to personalize the question.\\n- Return the question in this JSON format:",
        fields: [mockFields[7]]
    },
    {
        id: 6,
        aiGenerated: true,
        generateQuestions: true,
        requirements: "- Ensure the question provides meaningful insights about the user's success criteria.\\n- Use the user's previous answers to personalize the question.\\n- Return the question in this JSON format:",
        fields: [mockFields[8]]
    }
];
